...
class UserQueryActimetryAlgorithm(Resource):
    ...
    @api.doc(description='Get available processing algorithms or details about a specific one. If no algorithm key is '
                         'specified, returns all available processing algorithms.',
             responses={200: 'Success - returns list of algorithms.',
    ...
    def get(self):
        ...
        algos = [{'key': 'evenson2008',
                  ...
                  """,
                  'parameters': [{'name': 'sedentary_cutoff', 'description': 'Cut-off Sedentary (15s)'},
                                 {'name': 'light_cutoff', 'description': 'Cut-off Light (15s)'},
                                 {'name': 'moderate_cutoff', 'description': 'Cut-off Moderate (15s)'},
                                 {'name': 'vigorous_cutoff', 'description': 'Cut-off Vigorous (15s)'}],
                  'results': [{'name': 'sedentary_time', 'description': 'Sedentary Activity Time (minutes)'},
                                 {'name': 'light_time', 'description': 'Light Activity Time (minutes)'},
                                 {'name': 'moderate_time', 'description': 'Moderate Activity Time (minutes)'},
                                 {'name': 'vigorous_time', 'description': 'Vigorous Activity Time (minutes)'}]
                  },
                 {'key': 'freedson1998',
                  'name': 'Freedson 1998',
        ...
        if args['key']:
            ...
            return [algo for algo in algos if algo['key'] == args['key']][0], 200
